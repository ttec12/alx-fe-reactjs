...
export default function PostsComponent() {
  const {
    ...
    queryKey: ["posts"],
    queryFn: fetchPosts,
    staleTime: 5_000,              // fresh for 5s
    gcTime: 5 * 60 * 1000,         // keep unused cache 5m (v5 rename)
  ...
  return (
    <div className="p-4">
      ...
      <button onClick={() => refetch()} className="px-3 py-1 mb-4 bg-blue-600 text-white rounded">
        Refetch Posts
      </button>
